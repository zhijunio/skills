...
- `learning-records/NNNN-slug.md` captures what this run actually clarified
...
Topic directory layout: `workflow.md` → Workspace layout. README should explain file roles, **Recall / Explain** order, and `examples/README.md` when demos exist.
