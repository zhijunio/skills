...
Usage:
  python3 feishu-fetch.py "https://xxx.feishu.cn/docx/TOKEN"
  python3 feishu-fetch.py "https://xxx.feishu.cn/wiki/WIKI_TOKEN"
...
def main() -> None:
    if len(sys.argv) < 2:
        print("usage: feishu-fetch.py <feishu_or_lark_url>", file=sys.stderr)
        sys.exit(2)
